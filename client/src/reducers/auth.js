import { REGISTER_FAIL ,REGISTER_SUCCESS, USER_LOADED, AUTH_ERROR, LOGIN_SUCCESS, LOGIN_FAIL, LOGOUT, RECOVER_FAIL, RECOVER_SUCCESS, RESET_FAIL, RESET_SUCCESS, DELETE_SUCCESS, DELETE_FAIL, VOCABLIST_SUCCESS } from "../actions/types";
