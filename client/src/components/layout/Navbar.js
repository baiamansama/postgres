        ...
        <header className='text-blue-500 shadow w-full'>
            <div className='container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center'>
                ...
                <nav className='flex flex-wrap md:w-4/5 items-center justify-end text-base md:ml-auto'>
                    ...
                    <Link to='/register' class="flex items-center justify-center px-6 py-2 border-2 border-indigo-500 text-base font-medium rounded-md text-indigo-500  hover:text-gray-500 hover:border-gray-500 md:py-3 md:text-base md:px-10">
                        Free trial
                    </Link>
                </nav>
            </div>
