...
function PasswordReset({password_reset}) {
    ...
    return (
        ...
        <div className="text-3xl antialiased font-bold text-center text-indigo-900 mb-5">Reset Password</div>
...
export default connect(mapStateToProps, {password_reset})(PasswordReset)
